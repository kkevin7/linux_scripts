...
echo "=== Instalador NVIDIA para Debian 13 (MSI RTX 4070 Ventus) ==="
...
# 6. Forzar KDE en X11 para evitar problemas con Wayland
echo "[6/9] Forzando KDE Plasma en X11..."
sudo mkdir -p /etc/sddm.conf.d
cat <<EOF | sudo tee /etc/sddm.conf.d/force-x11.conf
[General]
...
# 8. Reiniciar
echo "[8/8] Instalación completada. Reinicia para aplicar los cambios."
